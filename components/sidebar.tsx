    ...
    <aside className="w-[260px] bg-slate-900/50 backdrop-blur-xl border-r border-white/5 flex flex-col h-screen">
      ...
      <div className="p-4 border-t border-white/5 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 px-3 py-2.5 text-sm text-slate-400 hover:text-cyan-400 transition-colors rounded-lg hover:bg-white/5"
        >
